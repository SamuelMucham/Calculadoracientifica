...
frame_quadros = Frame(janela, width=300, height=340, bg=co3, pady=0, padx=0, relief="flat",)
...
def calculate():
    ...
    modulos = ['math.tan','math.sin','math.cos','math.sqrt','math.log','mat.log10','math.e','math.pow','math.radian']
...
app_scream = Label(frame_score, width=16, height=2, textvariable= value_text, padx=7, relief="flat", anchor="e", justify=RIGHT, font=('Ivy 18'), bg='#37474F', fg=co1)
...
b_cos = Button(frame_cientifica, text="cos", width=6, height=1, bg=co10, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:scream_clear('cos'))
...
b_12.place(x=0, y=58)
b_13 = Button(frame_cientifica, text=",", width=6, height=1, bg=co10, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('e'))
